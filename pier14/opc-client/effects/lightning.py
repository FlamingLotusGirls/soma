...
class Lightning(EffectLayer):
    ...
    sequence = (
        ...
        [ 0.9,   '225@@@@@@__________________',   0.0 ],
        [ 0.7,   '____225@@@@@@______________',   0.0 ],
        [ 0.0,   '________225@@@@@@__________',   0.0 ],
        [ 0.0,   '____________225@@@@@@______',   0.0 ],
        [ 0.0,   '________________225@@@@@@__',   0.0 ],
        [ 0.0,   '___________________225@@@@@',   0.0 ],
