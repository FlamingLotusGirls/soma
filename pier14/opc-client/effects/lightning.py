...
class Lightning(EffectLayer):
    ...
    sequence = (
        ...
        [( r1 * 0.9,  g1 * 0.9,  b1 * 0.9 ), '5@@@@@@____________________', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.9,  g1 * 0.9,  b1 * 0.9 ), '225@@@@@@__________________', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.8,  g1 * 0.8,  b1 * 0.8 ), '__225@@@@@@________________', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.7,  g1 * 0.7,  b1 * 0.7 ), '____225@@@@@@______________', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '______225@@@@@@____________', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '________225@@@@@@__________', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '__________225@@@@@@________', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '____________225@@@@@@______', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '______________225@@@@@@____', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '________________225@@@@@@__', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '__________________225@@@@@ ', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '___________________225@@@@@', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '____________________225@@@@', (r2 * 0.0,  g2 * 0.0,   b2 * 0.0, )],
        ...
        [( r1 * 0.0,  g1 * 0.0,  b1 * 0.0 ), '___________________________', (r2 * 0.5,  g2 * 0.5,   b2 * 0.5, )],
